 ...
 * @author user
 */
public class TurnToOpposite extends ComposedAction {

    public TurnToOpposite(Coordinates c_current, Direction d) {
        super(c_current, d);
        super.add(new Heading(d.gauche()));
        super.add(new Scan());
        super.add(new Heading(d.gauche().gauche()));
        super.add(new Scan());
