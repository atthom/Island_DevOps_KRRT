...
public class UnextractedRessourceTest {
    ...
    @Before
    public void setUp(){ ur = new UnextractedResource();}

    @Test
    public void testGetA(){ assertEquals(Amount.UNKNOWN_AMOUNT, ur.getA());}

    @Test
    public void testGetCond(){ assertEquals(Condition.COND_UNKNOWN, ur.getCond());}
